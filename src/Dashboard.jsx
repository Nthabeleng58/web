...
<div className='rotating-image-container'>
  <img src="/food2.png" alt='Rotating' className='rotating-image'/>
</div>
      ...
      <div className="image-carousel">
        <Slider {...settings}>
          {images.map((index) => (
            <div key={index}>
              <img className="animated-image" src="food.png" alt={`Product ${index + 1}`} />
              <img className="animated-image" src="food3.png" alt={`Product ${index + 1}`} />
              <img className="animated-image" src="food2.png" alt={`Product ${index + 1}`} />
              <img className="animated-image" src="food1.png" alt={`Product ${index + 1}`} />
